    ...
    return(
        <div className='appDiv'>
            <Top />
                ...
                <div id='zen-preamble'>
                    <h3 className='bodyParagraphTitle'>The road to enlightenment</h3>
                ...
                <div id='zen-explanation'>
                    <h3 className='bodyParagraphTitle'>So what is this about?</h3>
                ...
                <div id='participationBenefitsDiv'>
                    <div id='zen-participation'>
                        <h3 className='bodyParagraphTitle'>Participation</h3>
                    ...
                    <div id='zen-benefits'>
                        <h3 className='bodyParagraphTitle'>Benefits</h3>
                ...
                <div id='zen-requirements'>
                    <h3 className='bodyParagraphTitle'>Requirements</h3>
                    ...
                    <p>This is a learning exercise as well as a demonstration. You retain full copyright on your graphics (with limited exceptions, <a href="http://www.mezzoblue.com/zengarden/submit/guidelines/"> see submission guidelines</a>), but we ask you release your CSS under a Creative Commons license identical to the <a href="https://creativecommons.org/licenses/by-nc-sa/3.0/">one on this site</a> so that others may learn from your work.</p>
                </div>
            <Footer />
            <MidCent />
            <ViewThis />
